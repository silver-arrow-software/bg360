...
class RssFeed extends ComponentBase
{
    ...
    {
        return [
            'name'        => 'sas.blog::lang.settings.rssfeed_title',
            'description' => 'sas.blog::lang.settings.rssfeed_description'
        ];
    }
    ...
    public function defineProperties()
    {
        return [
            ...
            'blogPage' => [
                'title'       => 'sas.blog::lang.settings.rssfeed_blog',
                'description' => 'sas.blog::lang.settings.rssfeed_blog_description',
                'type'        => 'dropdown',
                'default'     => 'blog/post',
                'group'       => 'Links',
            ],
