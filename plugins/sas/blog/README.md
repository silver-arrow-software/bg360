...
The post list and the pagination are coded in the default component partial `plugins/sas/blog/components/posts/default.htm`. If the default markup is not suitable for your website, feel free to copy it from the default partial and replace the `{% component %}` call in the example above with the partial contents.
...
The post details is coded in the default component partial `plugins/sas/blog/components/post/default.htm`.
...
The category list is coded in the default component partial `plugins/sas/blog/components/categories/default.htm`.
