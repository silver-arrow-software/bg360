...
class Post extends Model
{
    ...
    public $rules = [
        'title' => 'required',
        'slug' => ['required', 'regex:/^[a-z0-9\/\:_\-\*\[\]\+\?\|]*$/i', 'unique:sas_blog_posts'],
        'content' => 'required',
        'excerpt' => ''
    ];
    ...
    public $belongsToMany = [
        'categories' => [
            'Sas\Blog\Models\Category',
            'table' => 'sas_blog_posts_categories',
            'order' => 'name'
        ]
    ];
    ...
    public function filterFields($fields, $context = null)
    {
        ...
        if (!$user->hasAnyAccess(['sas.blog.access_publish'])) {
    ...
    public function afterValidate()
    {
        if ($this->published && !$this->published_at) {
            throw new ValidationException([
               'published_at' => Lang::get('sas.blog::lang.post.published_validation')
            ]);
        }
    }
    ...
    {
        return ($this->user_id == $user->id) || $user->hasAnyAccess(['sas.blog.access_other_posts']);
    }
