<?php namespace Sas\Forum\Models;
...
class Topic extends Model
{
     ...
     */
    public $hasOne = [
        'first_post' => ['Sas\Forum\Models\Post', 'order' => 'created_at asc']
    ];

    public $belongsTo = [
        'channel'          => ['Sas\Forum\Models\Channel'],
        'start_member'     => ['Sas\Forum\Models\Member'],
        'last_post'        => ['Sas\Forum\Models\Post'],
        'last_post_member' => ['Sas\Forum\Models\Member'],
    ];

    public $belongsToMany = [
        'followers' => ['Sas\Forum\Models\Member', 'table' => 'sas_forum_topic_followers', 'timestamps' => true]
    ];
