...
class Member extends ComponentBase
{
    ...
    /**
     * @var Sas\Forum\Models\Member Other member cache
     */
    ...
    {
        return [
            'name'        => 'sas.forum::lang.memberpage.name',
            'description' => 'sas.forum::lang.memberpage.self_desc'
        ];
    }
    ...
    public function defineProperties()
    {
        return [
            'slug' => [
                'title'       => 'sas.forum::lang.memberpage.slug_name',
                'description' => 'sas.forum::lang.memberpage.slug_desc',
                'default'     => '{{ :slug }}',
                'type'        => 'string'
            ],
            'viewMode' => [
                'title'       => 'sas.forum::lang.memberpage.view_title',
                'description' => 'sas.forum::lang.memberpage.view_desc',
                'type'        => 'dropdown',
                'default'     => ''
            ],
            'channelPage' => [
                'title'       => 'sas.forum::lang.memberpage.ch_title',
                'description' => 'sas.forum::lang.memberpage.ch_desc',
                'type'        => 'dropdown',
                'group'       => 'Links',
            ],
            'topicPage' => [
                'title'       => 'sas.forum::lang.memberpage.topic_title',
                'description' => 'sas.forum::lang.memberpage.topic_desc',
                'type'        => 'dropdown',
                'group'       => 'Links',
            ],
        ];
    ...
    {
        return ['topic_reply' => 'sas.forum::mail.topic_reply'];
    }
    ...
    public function onReport()
    {
        ...
        if ($moderators) {
            ...
            Mail::sendTo($moderators, 'sas.forum::mail.member_report', $params);
        }
