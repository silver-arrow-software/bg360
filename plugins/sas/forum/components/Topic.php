...
use Sas\Forum\Models\Post as PostModel;
use Sas\Forum\Models\TopicFollow;
...
class Topic extends ComponentBase
{
    ...
    /**
     * @var Sas\Forum\Models\Topic Topic cache
     */
    ...
    {
        return [
            'name'        => 'sas.forum::lang.topicpage.name',
            'description' => 'sas.forum::lang.topicpage.self_desc'
        ];
    }
    ...
    public function defineProperties()
    {
        return [
            'slug' => [
                'title'       => 'sas.forum::lang.topicpage.slug_name',
                'description' => 'sas.forum::lang.topicpage.slug_desc',
                'default'     => '{{ :slug }}',
                'type'        => 'string',
            ],
            'postsPerPage' => [
                'title'       => 'sas.forum::lang.topicpage.pagination_name',
                'default'     => '20',
                'type'        => 'string',
            ],
            'memberPage' => [
            ...
            'channelPage' => [
                'title'       => 'sas.forum::lang.topicpage.channel_title',
                'description' => 'sas.forum::lang.topicpage.channel_desc',
                'type'        => 'dropdown',
                'group'       => 'Links',
            ],
        ];
    ...
    protected function handleOptOutLinks()
    {
        ...
        if ($action == 'unsubscribe' && $member->user) {
            MailBlocker::addBlock('sas.forum::mail.topic_reply', $member->user);
    ...
    public function onCreate()
    {
        try {
             ...
             * Extensbility
             */
            Event::fire('sas.forum.topic.create', [$this, $topic, $topicUrl]);
    ...
    public function onPost()
    {
        try {
             ...
             * Extensbility
             */
            Event::fire('sas.forum.topic.post', [$this, $post, $postUrl]);
