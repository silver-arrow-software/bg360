...
class EmbedTopic extends ComponentBase
{
    ...
    {
        return [
            'name'        => 'sas.forum::lang.embedtopic.topic_name',
            'description' => 'sas.forum::lang.embedtopic.topic_self_desc'
        ];
    }
    ...
    public function defineProperties()
    {
        return [
            'embedCode' => [
                'title'       => 'sas.forum::lang.embedtopic.embed_title',
                'description' => 'sas.forum::lang.embedtopic.embed_desc',
                'type'        => 'string',
            ],
            'channelSlug' => [
                'title'       => 'sas.forum::lang.embedtopic.target_name',
                'description' => 'sas.forum::lang.embedtopic.target_desc',
                'type'        => 'dropdown'
            ],
            'memberPage' => [
