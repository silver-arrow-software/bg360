...
$(document).ready(function() {
    ...
    addColumn({name: "In Process"});
    addColumn({name: "Finished"});
...
function addTask(id) {
    ...
    var id = id || find_next_box_itm_free(1);
    var boxId = "box_itm" + id;

    $(".task_pool").first().append(' \
       <div class="big_container"> \
          <div id="'+ boxId +'" class="box_itm rounded"> \
              <div class="read-mode"> \
                  <div class="name box-data" n="name">Item ' + id + '</div> \
                  <div class="name box-data" n="desc">Resp ' + id + '</div> \
              ...
              <div class="edit-mode" style="display: none;"> \
                <div><span class="small">Name of the task:</span><input name="name" class="input box-data"/></div>  \
...
function addColumn(colData) {
    ...
    $("#task_pool_header_container").append(
        '<th id="' + headerId + '" class="task_pool_header">' +
            '<div class="read-mode">' +
