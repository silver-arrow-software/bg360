<?php namespace Sas\Social\Behaviors;

use Str;
use Sas\Social\Models\Like;
use Sas\Social\Models\Follow;
...
class SocialModel extends ModelBehavior
{
    ...
    public function __construct($model)
    {
        ...
        $model->hasMany['likes'] = ['Sas\Social\Models\Like'];
        $model->hasMany['comments'] = ['Sas\Social\Models\Comment'];
        $model->morphMany['followers'] = [
            'Sas\Social\Models\Follow',
            'name' => 'followable'
        ];
        $model->belongsToMany['follows'] = [
            'RainLab\User\Models\User',
            'table'    => 'sas_social_follows',
            'key'      => 'user_id',
